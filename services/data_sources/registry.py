...
def load_business_context(
    ...
    *,
    ...
    loaders: dict[str, Callable[[], BusinessDataContext]] = {
        ...
        "manual": lambda: manual.load_context(manual_db_path),
    ...
    if normalized_source != "manual":
        fallback_context = manual.load_context(manual_db_path)
        if fallback_context.available:
            fallback_context.metadata["fallback_from"] = normalized_source
