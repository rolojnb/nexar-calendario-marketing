...
class ProductData:
    """Producto normalizado para el motor de marketing.

    Esta estructura evita que el calendario dependa de una fuente concreta
    como Nexar Comercio, CSV, WooCommerce, Shopify u otra API futura.
    """
    ...
    def to_legacy_dict(self) -> dict[str, Any]:
        """Convierte el producto al formato que usa el motor actual.

        Mantener este adaptador permite migrar por etapas sin romper
        `services.motor_contenido`.
        """
...
class BusinessDataContext:
    """Contexto normalizado de datos comerciales."""
    ...
    def to_legacy_dict(self) -> dict[str, Any]:
        """Devuelve el formato histórico esperado por el motor actual."""
...
def empty_business_context(source: str = "none") -> BusinessDataContext:
    return BusinessDataContext(source=source)
